...
!(function (t, e) {
  ...
  function e(t, e, i, l, r) {
    ...
    (n = t),
      ...
      o &&
        (s.dispatchEvent(u("ps-scroll-" + l)),
        o < 0
          ? s.dispatchEvent(u("ps-scroll-" + r))
          : 0 < o && s.dispatchEvent(u("ps-scroll-" + h)),
        a &&
          (function (t, e) {
            v(t, e), Y(t, e);
          })(n, l)),
      n.reach[l] &&
        (o || c) &&
        s.dispatchEvent(u("ps-" + l + "-reach-" + n.reach[l]));
  }
  function p(t) {
  ...
  function X(t) {
    ...
    (t.containerWidth = r.clientWidth),
      ...
      r.contains(t.scrollbarYRail) ||
        (h(r, m.element.rail("y")).forEach(o), r.appendChild(t.scrollbarYRail)),
      ...
      i.isScrollbarXUsingBottom
        ? (l.bottom = i.scrollbarXBottom - n)
        : (l.top = i.scrollbarXTop + n),
      a(i.scrollbarXRail, l),
      (n = { top: n, height: i.railYHeight }),
      ...
      t.scrollbarXActive
        ? r.classList.add(m.state.active("x"))
        : (r.classList.remove(m.state.active("x")),
          (t.scrollbarXWidth = 0),
          (t.scrollbarXLeft = 0),
          (r.scrollLeft = 0)),
      t.scrollbarYActive
        ? r.classList.add(m.state.active("y"))
        : (r.classList.remove(m.state.active("y")),
  ...
  var w = {
        ...
        function t(t) {
          ...
          !(function (t, e, i) {
            ...
            (e =
              ...
              !(r = Math.abs(l) > Math.abs(i) ? n || o : s || r) ||
      ...
      touch: function (o) {
        ...
        function i(t) {
          ...
          u(t) &&
            ((e =
              (r = { pageX: (l = d(t)).pageX, pageY: l.pageY }).pageX -
              n.pageX),
            (i = r.pageY - n.pageY),
            (function (t, e, i) {
              if (s.contains(t))
      ...
      (this.scrollbarYRight = parseInt(n.right, 10)),
        isNaN(this.scrollbarYRight)
          ? ((this.isScrollbarYUsingRight = !1),
            (this.scrollbarYLeft = p(n.left)))
          : (this.isScrollbarYUsingRight = !0),
        (this.scrollbarYOuterWidth = this.isRtl
          ? p((o = f((o = this.scrollbarY))).width) +
            p(o.paddingLeft) +
            p(o.paddingRight) +
            p(o.borderLeftWidth) +
