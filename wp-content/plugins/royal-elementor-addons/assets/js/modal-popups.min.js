  ...
  var WprPopups = {
    ...
    openPopupInit: function () {
      $(".wpr-template-popup").each(function () {
        ...
        // Get Settings
        var getLocalStorage = JSON.parse(
            localStorage.getItem("WprPopupSettings")
          ),
        ...
        if ("load" === settings.popup_trigger) {
          ...
          $(window).on("scroll", function () {
            ...
            if (
              scrollPercent >= settings.popup_scroll_progress &&
              !popup.hasClass("wpr-popup-open")
            ) {
              WprPopups.openPopup(popup, settings);
            }
          });
          ...
          $(window).on("scroll", function () {
            ...
            if (
              element.offset().top < ScrollBottom &&
              !popup.hasClass("wpr-popup-open")
            ) {
              WprPopups.openPopup(popup, settings);
            }
        ...
        if ("0px" !== popup.find(".wpr-popup-container-inner").css("height")) {
          const ps = new PerfectScrollbar(
            popup.find(".wpr-popup-container-inner")[0],
            {
    ...
    openPopup: function (popup, settings) {
      if ("notification" === settings.popup_display_as) {
        ...
        setTimeout(function () {
          $("body").animate(
            {
              "padding-top":
                popup.find(".wpr-popup-container").outerHeight() + "px",
            },
            settings.popup_animation_duration * 1000,
            "linear"
          );
        }, 10);
      }
      ...
      // Disable Page Scroll
      if (
        settings.popup_disable_page_scroll &&
        "modal" === settings.popup_display_as
      ) {
      ...
      popup
        ...
        .addClass("animated " + settings.popup_animation);
    ...
    popupTriggerInit: function (popup) {
      ...
      popupTrigger.on("click", function () {
        // Get Settings
        var settings =
          JSON.parse(localStorage.getItem("WprPopupSettings")) || {};
        ...
        if ("close" === popupTriggerType) {
          settings[popupID].popup_show_again_delay = parseInt(
            popupShowDelay,
            10
          );
    ...
    checkAvailability: function (id) {
      ...
      if (
        "yes" === dataSettings.popup_show_via_referral &&
        -1 === currentURL.indexOf("wpr_templates=user-popup")
      ) {
      ...
      if (triggerShowDelay) {
        ...
        if (
          settings.popup_show_again_delay != dataSettings.popup_show_again_delay
        ) {
          return true;
        }
      }
